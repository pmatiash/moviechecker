...
class PostController extends CController
{
	...
	/**
	 * Creates a new post.
	 * If creation is successful, the browser will be redirected to the 'show' post.
	 */
	 ...
	 * If update is successful, the browser will be redirected to the 'show' post.
	 */
	 ...
	 * If deletion is successful, the browser will be redirected to the 'list' post.
	 */
