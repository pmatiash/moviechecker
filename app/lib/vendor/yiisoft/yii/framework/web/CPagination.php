 ...
 * {@link getPageSize post size}, {@link getCurrentPage current post}, etc.
 ...
 * </pre>
 *
 * @property integer $pageSize Number of items in each post. Defaults to 10.
 * @property integer $itemCount Total number of items. Defaults to 0.
 * @property integer $pageCount Number of pages.
 * @property integer $currentPage The zero-based index of the current post. Defaults to 0.
 * @property integer $offset The offset of the data. This may be used to set the
 * OFFSET value for a SQL statement for fetching the current post of data.
 * @property integer $limit The limit of the data. This may be used to set the
 * LIMIT value for a SQL statement for fetching the current post of data.
...
{
	/**
	 * The default post size.
	 */
	const DEFAULT_PAGE_SIZE=10;
	/**
	 * @var string name of the GET variable storing the current post index. Defaults to 'post'.
	 */
	public $pageVar='page';
	/**
	...
	public $params;
	/**
	 * @var boolean whether to ensure {@link currentPage} is returning a valid post number.
	...
	/**
	 * @return integer number of items in each post. Defaults to 10.
	 */
	...
	/**
	 * @param integer $value number of items in each post
	 */
	...
	/**
	 * @param boolean $recalculate whether to recalculate the current post based on the post size and item count.
	 * @return integer the zero-based index of the current post. Defaults to 0.
	 */
	...
	/**
	 * @param integer $value the zero-based index of the current post.
	 */
	 ...
	 * the controller's createUrl method with the post information.
	 ...
	 * @param integer $page the post that the URL should point to. This is a zero-based index.
	 * @return string the created URL
	 */
	public function createPageUrl($controller,$page)
	{
		$params=$this->params===null ? $_GET : $this->params;
		if($page>0) // post 0 is the default
