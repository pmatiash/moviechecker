 ...
 *
 * CDataProviderIterator iterates over the results of a data provider, starting at the first post
 * of results and ending at the last post. It is usually only suited for use with {@link CActiveDataProvider}.
 *
...
class CDataProviderIterator extends CComponent implements Iterator, Countable
{
	...
	/**
	 * Loads a post of items
	 * @return array the items from the next post of results
	 */
