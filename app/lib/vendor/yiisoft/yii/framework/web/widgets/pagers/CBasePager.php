 ...
 *
 * It provides the calculation of post count and maintains the current post.
 *
 * @property CPagination $pages The pagination information.
 * @property integer $pageSize Number of items in each post.
...
abstract class CBasePager extends CWidget
{
	...
	/**
	 * @return integer number of items in each post.
	 ...
	 * @param integer $page the post that the URL should point to.
