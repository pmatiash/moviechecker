 ...
 * the whole post containing the form is submitted. If there is any validation error,
 * CActiveForm will render the error in the post back to user.</li>
...
class CActiveForm extends CWidget
{
	 ...
	 * If not set, the current post URL is used.
	 */
	public $action='';
	/**
	...
	/**
	 * @var mixed form element to get initial input focus on post load.
	 *
	 ...
	 *
	 * Example - set input focus on post load to:
	 * <ul>
