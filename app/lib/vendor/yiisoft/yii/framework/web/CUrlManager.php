 ...
 * And given the route 'post/list' and GET parameter 'post' being 2, we should get a URL
 * '/index.php/posts/post/2'.
 *
...
class CUrlManager extends CApplicationComponent
{
	 ...
	 * For example, ".html" can be used so that the URL looks like pointing to a static HTML post. Defaults to empty.
	 */
	public $urlSuffix='';
	/**
...
class CUrlRule extends CBaseUrlRule
{
	 ...
	 * For example, ".html" can be used so that the URL looks like pointing to a static HTML post.
