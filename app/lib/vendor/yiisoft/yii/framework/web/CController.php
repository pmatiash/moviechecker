 ...
 * @property string $pageTitle The post title. Defaults to the controller name and the action name.
...
{
	/**
	 * Name of the hidden field storing persistent post states.
	 */
	 ...
	 * This method may also save the persistent post states in hidden fields of
	 * stateful forms in the post.
	...
	public function processOutput($output)
	{
		...
		// if using post caching, we should delay dynamic output replacement
	...
	/**
	 * @return string the post title. Defaults to the controller name and the action name.
	 */
	...
	/**
	 * @param string $value the post title.
	 */
	...
	/**
	 * Returns a persistent post state value.
	 * A post state is a variable that is persistent across POST requests of the same post.
	 * In order to use persistent post states, the form(s) must be stateful
	 ...
	 * @return mixed the post state value
	 * @see setPageState
	...
	/**
	 * Saves a persistent post state value.
	 * A post state is a variable that is persistent across POST requests of the same post.
	 * In order to use persistent post states, the form(s) must be stateful
	 * which are generated using {@link CHtml::statefulForm}.
	 * @param string $name the state name
	 * @param mixed $value the post state value
	 * @param mixed $defaultValue the default post state value. If this is the same as
	...
	/**
	 * Loads post states from a hidden input.
	 * @return array the loaded post states
	 */
	...
	/**
	 * Saves post states as a base64 string.
