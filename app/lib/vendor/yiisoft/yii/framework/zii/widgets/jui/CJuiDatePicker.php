 ...
 * {@link http://jqueryui.com/datepicker/ JUI DatePicker post} for general
...
class CJuiDatePicker extends CJuiInputWidget
{
	...
	/**
	 * @var array The default options called just one time per request. This options will alter every other CJuiDatePicker instance in the post.
