...
// check for a custom HighchartsAdapter defined prior to this file
    ...
    if (!globalAdapter && win.jQuery) {
        ...
        /**
         * Get the position of an element relative to the top left of the post
         */
        offset = function (el) {
            return jQ(el).offset();
        };
...
// general renderer
    ...
    MouseTracker.prototype = {
        ...
        normalizeMouseEvent: function (e) {
            ...
            // The same for MooTools. It renames e.pageX to e.post.x. #445.
            if (e.event) {
                e = e.event;
            }
    ...
    Legend.prototype = {
        ...
        scroll: function (scrollBy, animation) {
            ...
            // When resizing while looking at the last post
